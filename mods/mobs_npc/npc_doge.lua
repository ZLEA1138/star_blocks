...
local female_dress_default_color = {
	'^[colorize:#c00000:128', '^[colorize:#005c00:128', -- red, green
	'^[colorize:#000080:128', '^[colorize:#c0c000:128', '^[colorize:#800080:128'  -- blue, yellow, purple
}

-- default skin generation
for i = 1, 100 do
	if(i <= 50) -- 50% of all doges
	then -- Doge male
		table.insert(doge.default_skins, {
			'body_doge.png^('
	...
	elseif(i > 76) -- 25% of all doges
	then -- Doge female, pants or skirt
		table.insert(doge.default_skins, {
			'body_doge.png^('
	...
	else -- Doge female, dress, 25% of all doges
		table.insert(doge.default_skins, {
			'body_doge.png^('
			.. female_dress_default_base[math.random(2)] .. female_dress_default_color[math.random(5)] .. ')^('
			.. 'tail_doge.png)'
		})
	end
end
...
-- Doge (default)
mobs:register_mob("mobs_npc:doge_default", {
	type = "npc",
	passive = false,
	damage = 3,
...
mobs:register_egg("mobs_npc:doge_default", S("Doge (default)"), "desert_sand.png", 1)
