...
dungeon_loot.registered_loot = {
	-- various items
	{name = "wood:stick", chance = 0.6, count = {3, 6}},
	{name = "default:flint", chance = 0.4, count = {1, 3}},

	-- farming / consumable
	{name = "wood:tavifruit", chance = 0.4, count = {1, 4}},
	{name = "default:cactus", chance = 0.4, count = {1, 4},
		types = {"sandstone", "desert"}},

	-- minerals
	{name = "ores:coal_lump", chance = 0.9, count = {1, 12}},
	{name = "ores:aurum_lump", chance = 0.5},
	{name = "ores:ferrum_lump", chance = 0.4, count = {1, 6}},
	{name = "ores:wolfram_lump", chance = 0.1, count = {2, 3}},

	-- tools
	{name = "wood:sword_wood", chance = 0.6},
	{name = "default:pick_stone", chance = 0.3},
	{name = "ores:axe_wolfram", chance = 0.05},
