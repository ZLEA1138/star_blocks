...
plg.register_nodes = function(template)
	...
	for d = 0, 1 do
		...
		local texture = "fpga_top.png"
		if a == 1 then texture = texture .. "^microcontroller_LED_A.png" end
		if b == 1 then texture = texture .. "^microcontroller_LED_B.png" end
		if c == 1 then texture = texture .. "^microcontroller_LED_C.png" end
		if d == 1 then texture = texture .. "^microcontroller_LED_D.png" end
