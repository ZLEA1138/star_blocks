...
minetest.register_node("mesecons_pistons:piston_pusher_normal", {
	...
	drawtype = "nodebox",
	tiles = {
		"piston_pusher_top.png",
		"piston_pusher_bottom.png",
		"piston_pusher_left.png",
		"piston_pusher_right.png",
		"piston_pusher_back.png",
		"piston_pusher_front.png"
	},
...
minetest.register_node("mesecons_pistons:piston_sticky_off", {
	...
	tiles = {
		...
		"piston_right.png",
		"piston_back.png",
		"piston_pusher_front_sticky.png"
	},
	groups = {cracky = 3},
	paramtype2 = "facedir",
	is_ground_content = false,
...
minetest.register_craft({
	...
	recipe = {
		...
		{"mesecons_gamecompat:cobble", "mesecons_gamecompat:ferrum_ingot",  "mesecons_gamecompat:cobble"},
