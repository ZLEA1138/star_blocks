...
local function reset_formspec(meta, code, errmsg)
	...
	meta:set_string("formspec", "size[12,10]"
		...
		.."background[-0.2,-0.25;12.4,10.75;luac_background.png]"
		.."label[0.1,8.3;"..errmsg.."]"
		.."textarea[0.2,0.2;12.2,9.5;code;;"..code.."]"
		.."image_button[4.75,8.75;2.5,1;luac_runbutton.png;program;]"
		.."image_button_exit[11.72,-0.25;0.425,0.4;close_window.png;exit;]"
		)
end
...
for d = 0, 1 do
	...
	local top = "luacontroller_top.png"
	if a == 1 then
		top = top.."^luacontroller_LED_A.png"
	end
	if b == 1 then
		top = top.."^luacontroller_LED_B.png"
	end
	if c == 1 then
		top = top.."^luacontroller_LED_C.png"
	end
	if d == 1 then
		top = top.."^luacontroller_LED_D.png"
	end
...
minetest.register_node(BASENAME .. "_burnt", {
	...
	inventory_image = "luacontroller_burnt_top.png",
	is_burnt = true,
	paramtype = "light",
	is_ground_content = false,
...
minetest.register_craft({
	...
	recipe = {
		{'mesecons_materials:keiso',          'mesecons_materials:keiso',          'group:mesecon_conductor_craftable'},
		{'mesecons_materials:keiso',          'mesecons_materials:keiso',          'group:mesecon_conductor_craftable'},
