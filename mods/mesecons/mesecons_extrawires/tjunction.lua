...
minetest.register_node("mesecons_extrawires:tjunction_on", {
	drawtype = "nodebox",
	tiles = {
		"insulated_wire_tjunction_tb.png",
		"insulated_wire_tjunction_tb.png^[transformR180",
		"insulated_wire_end.png",
		"insulated_wire_end.png",
		"insulated_wire_side.png",
		"insulated_wire_end.png"
	},
	paramtype = "light",
	paramtype2 = "facedir",
...
minetest.register_node("mesecons_extrawires:tjunction_off", {
	drawtype = "nodebox",
	description = S("Insulated Wire T-junction"),
	tiles = {
		"insulated_wire_tjunction_tb.png",
		"insulated_wire_tjunction_tb.png^[transformR180",
		"insulated_wire_end.png",
