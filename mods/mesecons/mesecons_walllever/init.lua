...
mesecon.register_node("mesecons_walllever:wall_lever", {
	description = S("Lever"),
	drawtype = "mesh",
	inventory_image = "wall_lever_inv.png",
	wield_image = "wall_lever_inv.png",
	paramtype = "light",
	paramtype2 = "facedir",
	...
	tiles = {
		"wall_lever_lever_light_off.png",
		"wall_lever_front.png",
		"wall_lever_front_bump.png",
		"wall_lever_back_edges.png"
	},
