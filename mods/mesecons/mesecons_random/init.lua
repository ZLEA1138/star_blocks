...
minetest.register_node("mesecons_random:removestone", {
	tiles = {"removestone.png"},
	is_ground_content = false,
	inventory_image = minetest.inventorycube("removestone_inv.png"),
	groups = {cracky=3},
...
minetest.register_node("mesecons_random:ghoststone", {
	...
	tiles = {"ghoststone.png"},
	is_ground_content = false,
	inventory_image = minetest.inventorycube("ghoststone_inv.png"),
	groups = {cracky=3},
	sounds = mesecon.node_sound.stone,
	mesecons = {conductor = {
