...
local function register_gate(name, inputnumber, assess, recipe, description)
	...
	mesecon.register_node(basename, {
		...
		inventory_image = "gate_off.png^gate_"..name..".png",
		paramtype = "light",
		paramtype2 = "facedir",
		...
		tiles = {
			"microcontroller_bottom.png^".."gate_off.png^"..
			"gate_output.png^".."gate_"..name..".png",
			"microcontroller_bottom.png^".."gate_output.png^"..
			"[transformFY",
			"gate_side.png^".."gate_side_output.png",
			"gate_side.png",
			"gate_side.png",
			"gate_side.png"
		},
		...
		tiles = {
			"microcontroller_bottom.png^".."gate_on.png^"..
			"gate_output.png^".."gate_"..name..".png",
			"microcontroller_bottom.png^".."gate_output.png^"..
			"[transformFY",
			"gate_side.png^".."gate_side_output.png",
