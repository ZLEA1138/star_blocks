...
minetest.register_node("mesecons_hydroturbine:hydro_turbine_off", {
	...
	tiles = {
		"hydro_turbine_side_off.png",
		"hydro_turbine_top_bottom.png",
		"hydro_turbine_top_bottom_off.png",
		"hydro_turbine_misc_off.png"
	},
	use_texture_alpha = minetest.features.use_texture_alpha_string_modes and "opaque" or nil,
	inventory_image = "hydro_turbine_inv.png",
...
minetest.register_node("mesecons_hydroturbine:hydro_turbine_on", {
	...
	wield_scale = {x=0.75, y=0.75, z=0.75},
	tiles = {
		"hydro_turbine_side_on.png",
		"hydro_turbine_top_bottom.png",
		{ name = "hydro_turbine_top_bottom_on.png",
		    animation = {type = "vertical_frames", aspect_w = 128, aspect_h = 16, length = 1.6} },
		{ name = "hydro_turbine_misc_on.png",
...
minetest.register_craft({
	...
	recipe = {
	{"",            "group:stick",                      ""},
	{"group:stick", "mesecons_gamecompat:ferrum_ingot", "group:stick"},
	{"",            "group:stick",                      ""},
	}
})
