...
local tiles_off = { "wire.png" }
local tiles_on = { "wire.png" }
...
if minetest.registered_aliases["mesecons_gamecompat:cuprum_ingot"] then
	minetest.register_craft({
		type = "cooking",
		output = "mesecons:wire_00000000_off 18",
		recipe = minetest.registered_aliases["mesecons_gamecompat:cuprum_ingot"],
		cooktime = 15,
	})
end

if minetest.registered_aliases["mesecons_gamecompat:cuprum"] then
	minetest.register_craft({
		type = "cooking",
		output = "mesecons:wire_00000000_off 162",
		recipe = minetest.registered_aliases["mesecons_gamecompat:cuprum"],
		cooktime = 30,
	})
end
