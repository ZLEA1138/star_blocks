...
local top = "microcontroller_top.png"
if tostring(a) == "1" then
	top = top.."^microcontroller_LED_A.png"
end
if tostring(b) == "1" then
	top = top.."^microcontroller_LED_B.png"
end
if tostring(c) == "1" then
	top = top.."^microcontroller_LED_C.png"
end
if tostring(d) == "1" then
	top = top.."^microcontroller_LED_D.png"
end
local groups
