...
minetest.register_alias("mesecons:fusionreactor", "mesecons_powerplant:fusion_reactor")
minetest.register_alias("mesecons:fusion_reactor", "mesecons_powerplant:fusion_reactor")
minetest.register_alias("mesecons:lamp", "mesecons_lamp:lamp_off")
...
minetest.register_alias("mesecons:switch", "mesecons_switch:switch_off")
...
minetest.register_alias("mesecons:torch", "mesecons_torch:torch_on")
...
minetest.register_alias("mesecons:socket", "mesecons_temperest:socket_off")
minetest.register_alias("mesecons:inverter", "mesecons_temperest:inverter_on")
minetest.register_alias("mesecons:mover", "mesecons_movestones:mover")
minetest.register_alias("mesecons:sticky_mover", "mesecons_movestones:sticky_mover")
...
minetest.register_alias("mesecons:solar_panel", "mesecons_solarpanel:solar_panel_off")


--Backwards compatibility
minetest.register_alias("mesecons:wire_off", "mesecons:wire_00000000_off")
