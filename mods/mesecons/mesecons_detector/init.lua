...
local side_texture = mesecon.texture.steel_block or "detector_side.png"
...
minetest.register_node("mesecons_detector:object_detector_off", {
	tiles = {side_texture, side_texture, "object_detector_off.png", "object_detector_off.png", "object_detector_off.png", "object_detector_off.png"},
	paramtype = "light",
...
minetest.register_node("mesecons_detector:object_detector_on", {
	tiles = {side_texture, side_texture, "object_detector_on.png", "object_detector_on.png", "object_detector_on.png", "object_detector_on.png"},
	paramtype = "light",
	is_ground_content = false,
	walkable = true,
...
minetest.register_craft({
	...
	recipe = {
		{"mesecons_gamecompat:ferrum_ingot", "mesecons_gamecompat:ferrum_ingot",         "mesecons_gamecompat:ferrum_ingot"},
		{"mesecons_gamecompat:ferrum_ingot", "mesecons_luacontroller:luacontroller0000", "mesecons_gamecompat:ferrum_ingot"},
		{"mesecons_gamecompat:ferrum_ingot", "group:mesecon_conductor_craftable",        "mesecons_gamecompat:ferrum_ingot"},
	}
})
...
minetest.register_craft({
	...
	recipe = {
		{"mesecons_gamecompat:ferrum_ingot", "mesecons_gamecompat:ferrum_ingot",             "mesecons_gamecompat:ferrum_ingot"},
		{"mesecons_gamecompat:ferrum_ingot", "mesecons_microcontroller:microcontroller0000", "mesecons_gamecompat:ferrum_ingot"},
		{"mesecons_gamecompat:ferrum_ingot", "group:mesecon_conductor_craftable",            "mesecons_gamecompat:ferrum_ingot"},
	}
})
...
minetest.register_node("mesecons_detector:node_detector_off", {
	tiles = {side_texture, side_texture, side_texture, side_texture, side_texture, "node_detector_off.png"},
	paramtype = "light",
	paramtype2 = "facedir",
	is_ground_content = false,
	walkable = true,
...
minetest.register_node("mesecons_detector:node_detector_on", {
	tiles = {side_texture, side_texture, side_texture, side_texture, side_texture, "node_detector_on.png"},
	paramtype = "light",
	paramtype2 = "facedir",
	is_ground_content = false,
	walkable = true,
