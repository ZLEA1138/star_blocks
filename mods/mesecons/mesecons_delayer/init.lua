...
local off_state = {
	...
	tiles = {
		"delayer_off_"..tostring(i)..".png",
		"delayer_bottom.png",
		"delayer_end_off.png",
		"delayer_end_off.png",
		"delayer_side_off.png",
		"delayer_side_off.png"
	},
	inventory_image = "delayer_off_1.png",
	wield_image = "delayer_off_1.png",
	groups = off_groups,
...
minetest.register_craft({
	...
	recipe = {
		{"mesecons_torch:torch_on",   "group:mesecon_conductor_craftable", "mesecons_torch:torch_on"},
