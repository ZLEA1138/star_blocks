...
minetest.register_node("farming:seed_cotton", {
	...
	tiles = {"cotton_seed.png"},
	inventory_image = "cotton_seed.png",
	wield_image = "cotton_seed.png",
	drawtype = "signlike",
	groups = {
...
def = {
	grow_on = mg and {"ethereal:jungle_dirt"} or {"ethereal:savanna_dirt"},
