...
minetest.register_craftitem("farming:rice_bread", {
	...
	inventory_image = "rice_bread.png",
...
minetest.register_craftitem("farming:rice_flour", {
	...
	inventory_image = "rice_flour.png",
