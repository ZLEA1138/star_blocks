...
--	drawtype = "plantlike",
--	tiles = {"bottle_ethanol.png"},
--	inventory_image = "bottle_ethanol.png",
--	wield_image = "bottle_ethanol.png",
--	paramtype = "light",
