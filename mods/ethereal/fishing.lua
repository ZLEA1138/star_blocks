...
for n = 1, #fish do
	...
	minetest.register_craftitem("ethereal:fish_" .. fish[n][2], {
		...
		inventory_image = "fish_" .. fish[n][2] .. ".png",
		on_use = usage,
		groups = groups
	})
end
...
-- Worm
minetest.register_craftitem("ethereal:blindworm", {
	description = S("Blindworm"),
	inventory_image = "blindworm.png",
	wield_image = "blindworm.png"
})

minetest.register_craft({
	output = "ethereal:blindworm",
	recipe = {
