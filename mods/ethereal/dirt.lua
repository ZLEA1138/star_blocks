...
for n = 1, #dirts do
	...
	minetest.register_node("ethereal:"..name.."_dirt", {
		...
		tiles = {
			...
			"dirt.png",
			{
				name = "dirt.png^dirt_"..name.."_side.png",
...
-- Snow dirt
minetest.register_node("ethereal:snow_dirt", {
	description = S("Snow Dirt"),
	tiles = {
		"snow.png",
		"dirt.png",
		{
...
local flower_spread = function(pos, node)
	...
	if num > 3 and node.name == "ethereal:dry_shrub" then
