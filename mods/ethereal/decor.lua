...
add_node({"ethereal:savanna_dirt"}, 0.10, {"mesa"}, 1, 100,
	{"default:dry_grass_2", "default:dry_grass_3", "default:dry_grass_4",
...
-- flowers & strawberry
--add_node({"ethereal:grass_dirt"}, 0.025, {"deciduous_forest"}, 1, 100,
...
-- snowy grass
add_node({"ethereal:cold_dirt"}, 0.05, {"cold"}, 1, 100,
	{"ethereal:snowy_grass"}, nil, nil, nil, ethereal.grayness)

add_node({"ethereal:cold_dirt"}, 0.05,
	{"coniferous_forest"}, 1, 100, {"ethereal:snowy_grass"}, nil, nil, nil, ethereal.snowy)
...
-- wild red mushroom
add_node({"ethereal:fungus_dirt"}, 0.01, {"mushroom"}, 1, 100,
	{"flowers:mushroom_red"}, nil, nil, nil, ethereal.mushroom)

local list = {
	{"junglee", {"ethereal:jungle_dirt"}, ethereal.junglee},
	{"deciduous_forest", {"ethereal:grass_dirt"}, ethereal.grassy},
	{"grassytwo", {"ethereal:grass_dirt"}, ethereal.grassytwo},
	{"prairie", {"ethereal:prairie_dirt"}, ethereal.prairie},
	{"mushroom", {"ethereal:fungus_dirt"}, ethereal.mushroom},
...
-- jungle grass
add_node({"ethereal:jungle_dirt"},
	0.10, {"junglee"}, 1, 100, {"default:jungle_grass"}, nil, nil, nil,
	ethereal.junglee)

add_node({"ethereal:grass_dirt"}, 0.15, {"jumble"}, 1, 100,
	{"default:jungle_grass"}, nil, nil, nil, ethereal.jumble)

add_node({"ethereal:swamp_dirt"}, 0.25, {"swamp"}, 1, 100,
	{"default:jungle_grass"}, nil, nil, nil, ethereal.swamp)

-- grass
add_node({"ethereal:grass_dirt"}, 0.35, {"deciduous_forest"}, 1, 100,
	{"default:grass_2", "default:grass_3", "default:grass_4",
	"default:grass_5"}, nil, nil, nil, ethereal.grassy)

add_node({"ethereal:grass_dirt"}, 0.35, {"grassytwo"}, 1, 100,
	{"default:grass_2", "default:grass_3", "default:grass_4",
	"default:grass_5"}, nil, nil, nil, ethereal.grassytwo)

add_node({"ethereal:grass_dirt"}, 0.35, {"jumble"}, 1, 100,
	{"default:grass_2", "default:grass_3", "default:grass_4",
...
add_node({"ethereal:grass_dirt"}, 0.35, {"grove"}, 1, 100,
	{"default:grass_2", "default:grass_3", "default:grass_4",
	"default:grass_5"}, nil, nil, nil, ethereal.grove)

add_node({"ethereal:grass_dirt"}, 0.35, {"mediterranean"}, 1, 100,
	{"default:grass_2", "default:grass_3", "default:grass_4",
...
add_node({"ethereal:grass_dirt"}, 0.35, {"grassland"},
	1, 100, {"default:grass_3", "default:grass_4"}, nil, nil, nil, 1)

add_node({"ethereal:swamp_dirt"}, 0.35, {"swamp"},
	1, 100, {"default:grass_3", "default:grass_4"}, nil, nil, nil, 1)

-- saago grass on sand
add_node({"default:sand"}, 0.25, {"sandclay"}, 3, 4, {"default:saago_grass_1",
	"default:saago_grass_2", "default:saago_grass_3"}, nil, nil, nil,
	ethereal.sandclay)

-- ferns
add_node({"ethereal:grass_dirt"}, 0.2, {"grove"}, 1, 100, {"ethereal:fern"},
	nil, nil, nil, ethereal.grove)

add_node({"ethereal:swamp_dirt"}, 0.1, {"swamp"}, 1, 100,
	{"ethereal:fern"}, nil, nil, nil, ethereal.swamp)

-- snow
add_node({"ethereal:cold_dirt"},
...
-- wild onion
add_node({"ethereal:grass_dirt", "ethereal:prairie_dirt"}, 0.25,
	{"deciduous_forest", "grassytwo", "jumble", "prairie"}, 1, 100,
	{"ethereal:onion_4"}, nil, nil, nil, 1)

-- reeds
add_node({"ethereal:grass_dirt"}, 0.1, {"deciduous_forest"}, 1, 1,
	{"default:reeds"}, 4, "default:water_source", 1, ethereal.grassy)

add_node({"ethereal:jungle_dirt"},
	0.1, {"junglee"}, 1, 1, {"default:reeds"}, 4, "default:water_source",
	1, ethereal.junglee)

add_node({"ethereal:grass_dirt"}, 0.1, {"swamp"}, 1, 1,
	{"default:reeds"}, 4, "default:water_source", 1, ethereal.swamp)
...
if minetest.get_modpath("butterflies") then
	...
	minetest.register_decoration({
		...
		deco_type = "simple",
		place_on = {"ethereal:grass_dirt", "ethereal:prairie_dirt"},
		place_offset_y = 2,
		sidelen = 80,
		fill_ratio = 0.005,
