...
function skin_class:get_preview()
	...
	--Chest
	skin = skin .. "([combine:32x64:-32,-24=" .. player_skin .. "^[mask:mask_chest.png)^"
	--Head
	skin = skin .. "([combine:32x64:-8,-16=" .. player_skin .. "^[mask:mask_head.png)^"
	--Hat
	skin = skin .. "([combine:32x64:-72,-16=" .. player_skin .. "^[mask:mask_head.png)^"
	--Right Arm
	skin = skin .. "([combine:32x64:-88,-24=" .. player_skin .. "^[mask:mask_rarm.png)^"
	--Right Leg
	skin = skin .. "([combine:32x64:0,0=" .. player_skin .. "^[mask:mask_rleg.png)^"
	...
	if self:get_meta("format") == "1.8" then
		left_arm = "([combine:32x64:-48,-88=" .. player_skin .. "^[mask:(mask_rarm.png^[transformFX))^"
		left_leg = "([combine:32x64:-24,-64=" .. player_skin .. "^[mask:(mask_rleg.png^[transformFX))^"
	else
		left_arm = "([combine:32x64:-88,-24=" .. player_skin .. "^[mask:mask_rarm.png^[transformFX)^"
		left_leg = "([combine:32x64:0,0=" .. player_skin .. "^[mask:mask_rleg.png^[transformFX)^"
	end
	...
	--Chest Overlay
	skin = skin .. "([combine:32x64:-32,-56=" .. player_skin .. "^[mask:mask_chest.png)^"
	--Right Arm Overlay
	skin = skin .. "([combine:32x64:-88,-56=" .. player_skin .. "^[mask:mask_rarm.png)^"
	--Right Leg Overlay
	skin = skin .. "([combine:32x64:0,-32=" .. player_skin .. "^[mask:mask_rleg.png)^"
	--Left Arm Overlay
	skin = skin .. "([combine:32x64:-80,-88=" .. player_skin .. "^[mask:(mask_rarm.png^[transformFX))^"
	--Left Leg Overlay
	skin = skin .. "([combine:32x64:8,-64=" .. player_skin .. "^[mask:(mask_rleg.png^[transformFX))"

	-- Full Preview
	skin = "(((" .. skin .. ")^[resize:64x128)^[mask:transform.png)"
