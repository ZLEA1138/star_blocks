...
--		skins = {"felis_black.png"}
--	}
--}

-- Kitten by Jordach / BFD

mobs:register_mob("mobs_animal:felis", {
	stepheight = 0.6,
	type = "animal",
	specific_attack = {"mobs_animal:mus"},
	damage = 1,
	attack_type = "dogfight",
	attack_animals = true, -- so it can attack mus
	...
	follow = {
		"mobs_animal:mus", "group:food_fish_raw"
	},
	view_range = 8,

	-- check surrounding nodes and spawn a specific felis
	on_spawn = function(self)

		local pos = self.object:get_pos() ; pos.y = pos.y - 1
		local tmp

--		for n = 1, #felis_types do
...
mobs:register_egg("mobs_animal:felis", S("Felis"), "felis_inv.png", 0)


mobs:alias_mob("mobs:felis", "mobs_animal:felis") -- compatibility


local hairball_items = {
	"default:stick", "default:coal_lump", "default:dry_shrub", "flowers:rose",
	"mobs_animal:mus", "default:grass_1", "farming:seed_wheat", "dye:green", "",
	"farming:seed_cotton", "default:flint", "wood:tavifruit_sapling", "dye:white", "",
	"default:clay_lump", "default:paper", "default:dry_grass_1", "dye:red", "",
	"farming:string", "mobs:pullum_feather", "ethereal:bush_sapling", "",
	"default:cuprum_lump", "default:ferrum_lump", "", "",
	"dye:black", "dye:brown", "default:obsidian_shard", "default:stannum_lump",
	--"ethereal:fish_tetra"
}

minetest.register_craftitem(":mobs:hairball", {
	description = S("Hairball"),
	inventory_image = "hairball.png",
