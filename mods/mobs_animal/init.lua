...
-- Animals
ddoo("pullum") -- JKmurray
ddoo("bovis") -- KrupnoPavel
ddoo("mus") -- PilzAdam
ddoo("schaap") -- PilzAdam
ddoo("porcus") -- KrupnoPavel
ddoo("apis") -- KrupnoPavel
ddoo("aurisbellus") -- ExeterDad
ddoo("felis") -- Jordach/BFD
ddoo("tavinbear") -- AspireMint
