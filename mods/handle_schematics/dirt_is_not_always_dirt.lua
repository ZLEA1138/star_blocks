...
handle_schematics.enable_use_dirt_as_placeholder = function()
	local fill_nodes = {"default:stone","ores:stone_with_coal","ores:stone_with_ferrum",
		"ores:stone_with_cuprum","ores:stone_with_adamas","ores:stone_with_wolfram",
		"ores:stone_with_aurum","ores:stone_with_stannum",
		"default:desert_stone",
		"default:cobble","default:cobble_mossy","default:sandstone","default:silver_sandstone",
		-- falling nodes would be too problematic in this case;
		-- diffrent dirt types
		"ethereal:bamboo_dirt","ethereal:grass_dirt","ethereal:jungle_dirt",
	...
	fill_nodes = {
		...
		"ethereal:fungus_dirt",
		"ethereal:swamp_dirt",
		"ethereal:snow_dirt","default:dirt","default:snow_block","default:ice"};
	for i,v in ipairs( fill_nodes ) do
		handle_schematics.add_also_acceptable( "ethereal:grass_dirt", v )
	end
end
