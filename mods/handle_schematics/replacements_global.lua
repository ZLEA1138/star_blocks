...
handle_schematics.replace_material = function( replacements, material_type, old_material, new_material)
	...
	if( not( old_material )) then
		if(     material_type == 'wood') then
			old_material = 'wood:tavifruit_wood'
...
handle_schematics.replace_randomized = function( replacements, new_materials )
	...
	table.insert( replacements, {"cottages:chest_private", "wood:chest_wood"});
	table.insert( replacements, {"cottages:chest_work",    "wood:chest_wood"});
	table.insert( replacements, {"cottages:chest_storage", "wood:chest_wood"});
