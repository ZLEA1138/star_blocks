...
minetest.register_node("handle_schematics:build", {
	...
	tiles = {"tavifruit_wood.png^[transformR90", "tavifruit_wood.png^[transformR90",
		 "tavifruit_wood.png^[transformR90", "tavifruit_wood.png^[transformR90",
		 "tavifruit_wood.png^[transformR90", "tavifruit_wood.png^grundriss.png^[transformR90"},
