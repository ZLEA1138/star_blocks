...
local teleport_pad_texture = "teleport_pad.png"
...
local function set_teleport_destination(playername, dest)
	...
	effect(dest, 20, "teleport_particle.png", 0.5, 1.5, 1, 7, 15)
...
--				effect(oldpos, 25, "teleport_particle.png", 2, 2, 1, -10, 15)
...
--				effect(self.lastpos, 20, "teleport_particle.png", 2, 2, 1, 10, 15)
--			end
...
minetest.register_node("teleport_potion:pad", {
	...
	after_place_node = function(pos, placer, itemstack, pointed_thing)
		...
		effect(pos, 20, "teleport_particle.png", 0.5, 1.5, 1, 7, 15)
...
minetest.register_craft({
	...
	recipe = {
		...
		{"default:glass", "uraniumstuff:uran_gem", "default:glass"},
		{"default:glass", "default:glass",         "default:glass"}
	}
})
...
minetest.register_abm({
	label = "Pad teleportation",
	nodenames = {"teleport_potion:pad"},
	interval = 2,
	chance = 1,
	catch_up = false,
	...
	action = function(pos, node, active_object_count, active_object_count_wider)
		...
		for n = 1, #objs do
			...
			if objs[n]:is_player() then
				...
				effect(pos, 25, "teleport_particle.png", 2, 2, 1, -10, 15)

				-- move player
				objs[n]:set_pos(target_coords)

				-- paricle effects on arrival
				effect(target_coords, 20, "teleport_particle.png", 2, 2, 1, 10, 15)
