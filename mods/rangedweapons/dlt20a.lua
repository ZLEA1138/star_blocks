minetest.register_tool("rangedweapons:dlt20a", {
    ...
    RW_powergun_capabilities = {
		...
		power_critEffc = 2.0,
		power_skill = {"",1},
		power_cooling = "rangedweapons:dlt20a",
		power_velocity = 60,
		power_accuracy = 80,
		power_cooldown = 0.5,
		power_projectiles = 1,
