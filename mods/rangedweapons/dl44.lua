minetest.register_tool("rangedweapons:dl44", {
    ...
    RW_powergun_capabilities = {
		...
		power_critEffc = 2.0,
		power_skill = {"",1},
		power_cooling = "rangedweapons:dl44",
		power_velocity = 60,
		power_accuracy = 70,
		power_cooldown = 1,
		power_projectiles = 1,
