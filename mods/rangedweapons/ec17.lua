minetest.register_tool("rangedweapons:ec17", {
    ...
    RW_powergun_capabilities = {
		...
		power_critEffc = 2.0,
		power_skill = {"",1},
		power_cooling = "rangedweapons:ec17",
		power_velocity = 60,
		power_accuracy = 50,
		power_cooldown = 0.5,
		power_projectiles = 1,
