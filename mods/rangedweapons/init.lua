...
if player_has_ammo == 1 then
local gun_icon = "emergency_gun_icon.png"

if GunCaps.gun_icon ~= nil then
gun_icon = GunCaps.gun_icon
end

local ammo_icon = "emergency_ammo_icon.png"
...
if GunCaps.gun_magazine ~= nil then
		...
		local yaw = player:get_look_horizontal() + 1.57
...
--	dofile(modpath.."/bowcaster.lua")
--	dofile(modpath.."/dc15a.lua")
--	dofile(modpath.."/dc15s.lua")
--	dofile(modpath.."/dc17.lua")
--	dofile(modpath.."/dh17.lua")
--	dofile(modpath.."/dl44.lua")
	dofile(modpath.."/cr12.lua")
	dofile(modpath.."/cr15.lua")
	dofile(modpath.."/fr20.lua")
	dofile(modpath.."/fc37.lua")
	dofile(modpath.."/cfc38.lua")
	dofile(modpath.."/fc53.lua")
...
player:hud_change(hit, "text", "blank.png")
	timer = 0
			end
			end
				end)
