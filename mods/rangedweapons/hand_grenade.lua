...
then
	...
	minetest.sound_play("rangedweapons_reload_a", {user})
		itemstack = "rangedweapons:grenade_armed"
local pos = user:get_pos()
pos.y = pos.y + 1.5
local pinEnt = null --minetest.add_entity(pos, "rangedweapons:grenade_pin")
if pinEnt then
...
minetest.register_globalstep(function(dtime, player, pos)
	...
	local pos = player:get_pos()
		if player:get_wielded_item():get_name() == "rangedweapons:grenade_armed" then
