minetest.register_tool("rangedweapons:dc15s", {
    ...
    RW_powergun_capabilities = {
		...
		power_critEffc = 2.0,
		power_skill = {"",1},
		power_cooling = "rangedweapons:dc15s",
		power_velocity = 60,
		power_accuracy = 80,
		power_cooldown = 0.5,
		power_projectiles = 1,
