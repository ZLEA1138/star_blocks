minetest.register_craftitem("rangedweapons:laser_bolt_blue", {
	wield_scale = {x=1.75,y=1.75,z=1.75},
	inventory_image = "laser_bolt_blue.png",
})

minetest.register_craftitem("rangedweapons:laser_bolt_red", {
	wield_scale = {x=1.75,y=1.75,z=1.75},
	inventory_image = "laser_bolt_red.png",
})

minetest.register_craftitem("rangedweapons:laser_bolt_green", {
	wield_scale = {x=1.75,y=1.75,z=1.75},
	inventory_image = "laser_bolt_green.png",
})

minetest.register_craftitem("rangedweapons:laser_bolt_yellow", {
	wield_scale = {x=1.75,y=1.75,z=1.75},
	inventory_image = "laser_bolt_yellow.png",
})

minetest.register_craftitem("rangedweapons:laser_bolt_blue_training", {
	wield_scale = {x=1.75,y=1.75,z=1.75},
	inventory_image = "laser_bolt_blue_training.png",
})

minetest.register_craftitem("rangedweapons:laser_bolt_red_training", {
	wield_scale = {x=1.75,y=1.75,z=1.75},
	inventory_image = "laser_bolt_red_training.png",
})

minetest.register_craftitem("rangedweapons:laser_bolt_green_training", {
	wield_scale = {x=1.75,y=1.75,z=1.75},
	inventory_image = "laser_bolt_green_training.png",
})

minetest.register_craftitem("rangedweapons:laser_bolt_yellow_training", {
	wield_scale = {x=1.75,y=1.75,z=1.75},
	inventory_image = "laser_bolt_yellow_training.png",
})
