...
local armor_stand_formspec = "size[8,7]" ..
	...
	"image[3,0.5;1,1;armor_stand_head.png]" ..
	"image[4,0.5;1,1;armor_stand_torso.png]" ..
	"image[3,1.5;1,1;armor_stand_legs.png]" ..
	"image[4,1.5;1,1;armor_stand_feet.png]" ..
...
local function update_entity(pos)
	...
	if object then
		local texture = "armor_transparent.png"
		local textures = {}
		local meta = minetest.get_meta(pos)
		local inv = meta:get_inventory()
		local yaw = 0
...
minetest.register_entity("3d_armor_stand:armor_entity", {
	initial_properties = {
		...
		textures = {"armor_transparent.png"},
	},
	_pos = nil,
